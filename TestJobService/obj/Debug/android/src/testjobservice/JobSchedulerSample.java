...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TestJobService.JobScedulerSample, TestJobService, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", JobSchedulerSample.class, __md_methods);
	}


	public JobSchedulerSample ()
	{
		super ();
		if (getClass () == JobSchedulerSample.class)
